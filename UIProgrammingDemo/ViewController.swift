...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var placeNameLabel = UILabel(frame: CGRect(x: 0, y: 80, width: UIScreen.mainScreen().bounds.width - 20, height: 40))
    ...
    override func viewDidLoad() {
        ...
        thingsLabel.text = "Space needle, science center, aquarium, movie theaters, golfing, football, rocky beaches, community fairs, etc. "
